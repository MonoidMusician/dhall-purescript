...
instance showExpr :: (TraversableWithIndex String m, Show a) => Show (Expr m a) where
  show (Expr e0) = cata show1 e0 where
    ...
    show1 = unwrap >>> either (\e -> "(mkEmbed (" <> show e <> "))")
      ...
      # VariantF.on (_S::S_ "Bool") (const "mkBool")
      # VariantF.on (_S::S_ "Natural") (const "mkNatural")
      # VariantF.on (_S::S_ "Integer") (const "mkInteger")
      # VariantF.on (_S::S_ "Double") (const "mkDouble")
      # VariantF.on (_S::S_ "Text") (const "mkText")
      # VariantF.on (_S::S_ "List") (const "mkList")
      # VariantF.on (_S::S_ "Optional") (const "mkOptional")
      # VariantF.on (_S::S_ "NaturalFold") (const "mkNaturalFold")
      # VariantF.on (_S::S_ "NaturalBuild") (const "mkNaturalBuild")
      # VariantF.on (_S::S_ "NaturalIsZero") (const "mkNaturalIsZero")
      # VariantF.on (_S::S_ "NaturalEven") (const "mkNaturalEven")
      ...
      # VariantF.on (_S::S_ "ListLength") (const "mkListLength")
      # VariantF.on (_S::S_ "ListHead") (const "mkListHead")
